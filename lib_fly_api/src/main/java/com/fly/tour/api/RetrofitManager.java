...
import com.fly.tour.api.http.MyGsonConverterFactory;
import com.fly.tour.api.http.MyInterceptor;
...
//                .addConverterFactory(GsonConverterFactory.create())
    ...
    public SquareService getSquareService() {
        return mRetrofit.create(SquareService.class);
    }
    ...
    public RankService getRankService() {
        return mRetrofit.create(RankService.class);
    }
